	...
	(SEMICOLON.initialize = {
		...
		defaults: function () {
			...
			goToTopScroll: function () {
				...
				if ((i || (i = 450), "true" != e && (o.hasClass("device-sm") || o.hasClass("device-xs"))))
					return !0;
								...
								dataResponsiveClasses: function () {
									...
									(SEMICOLON.header = {
										...
										menufunctions: function () {
											...
											: c.css({ "margin-top": "" }),
											o.hasClass("overlay-menu") && M.hasClass("on-click") && (o.hasClass("device-xl") || o.hasClass("device-lg"))
											...
											: (o.hasClass("side-header") && M.hasClass("on-click")) || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")
											...
											.on("click", function () {
												...
												? (e(".primary-menu:not(.mobile-menu-off-canvas) .mobile-primary-menu").stop(!0, !0).slideToggle(a), e(".primary-menu.mobile-menu-off-canvas .mobile-primary-menu").toggleClass("d-block"))
												: (e(".primary-menu:not(.mobile-menu-off-canvas) .menu-container").stop(!0, !0).slideToggle(a), e(".primary-menu.mobile-menu-off-canvas .menu-container").toggleClass("d-block"))),
										...
										fullWidthMenu: function () {
											if (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs"))
												return e(".mega-menu-content, .top-search-form").css({ width: "" }), !0;
											let i = e(".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content").parents(".header-row").width();
											if (
											(d.find(".container-fullwidth").length > 0 && e(".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content").css({ width: i }),
											...
											: d.hasClass("full-header") && e(".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content").css({ width: i - 80 }),
										...
										stickyPageMenu: function (e) {
											if (a.scrollTop() > e)
												...
												.find(B)
												.css({ top: e + "px" });
											} else (o.hasClass("device-sm") || o.hasClass("device-xs") || o.hasClass("device-md"))
												&& "true" == $.attr("data-mobile-sticky") && $.filter(":not(.dots-menu,.no-sticky)").addClass("sticky-page-menu");
											else
												$.removeClass("sticky-page-menu"), $.find(B).css({ top: "" });
										},
										...
										(SEMICOLON.slider = {
											...
											sliderDimensions: function () {
												...
												if (o.hasClass("device-xl") || o.hasClass("device-lg")) {
													...
													t.css({ height: "" }), Q.css({ height: "" }), n.css({ width: "", height: "" });
											},
											sliderRun: function (e) {
												...
												sliderElementsFade: function () {
													...
													if ((!o.hasClass("device-xl") && !o.hasClass("device-lg")) || SEMICOLON.isMobile.any())
														Q.find(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").css({ opacity: 1 });
													else {
																																							...
																																							notifications: function (e) {
																																								...
																																								textRotator: function (e) {
																																									...
																																									linkScroll: function (e) {
																																										...
																																										ajaxForm: function (e) {
																																											let i = { element: e,
																																											default: ".form-widget", file: "plugins.form.js", error: "plugins.form.js: Plugin could not be loaded", execfn: !1, pluginfn: "$().validate && $().ajaxSubmit", class: "has-plugin-form" },
																																												n =
																																												{
																																													element: e,
																																												default: ".form-widget",
																																												...
																																												subscription: function (e) {
																																													let i = { element: e,
																																													default: ".subscribe-widget", file: "plugins.form.js", error: "plugins.form.js: Plugin could not be loaded", execfn: !1, pluginfn: "$().validate && $().ajaxSubmit", class: "has-plugin-form" },
																																														n =
																																														{
																																															element: e,
																																																...
																																																stickySidebar: function (e) {
																																																	...
																																																	cookieNotify: function (e) {
																																																		...
																																																		cartQuantity: function () {
																																																				...
																																																				pricingSwitcher: function () {
																																																					...
																																																					extras: function () {
																																																						e(window).on("pluginBootstrapReady", function () {
																																																							e().tooltip ? e('[data-toggle="tooltip"]').tooltip({ container: "body" }) : console.log("extras: Bootstrap Tooltip not defined."),
																																																			...
																																																			function consultar_zona()
																																																			{	console.log( "Elige tu zona de acuerdo al mapa" );
																																																				$.post("php/app_sesiones_ver.php",{name:'zona'},function(data) {
																																																					if (data==1 || data==2 || data==3 || data==4 )
																																																						$("#z"+data).addClass('selected');
																																																				});
																																																			...
																																																			$('[id^=z]').click(function() {
																																																				...
																																																				$.post("php/app_sesiones.php",{name:'zona', valor: zona},function(data) {
																																																					console.log(data);
																																																			...
																																																			function consultar_aire()
																																																			{	console.log( "Elige el tipo de aire acondicionado" );
																																																				$.post("php/app_sesiones_ver.php",{name:'zona'},function(data) {
																																																					if (data==1 || data==2 || data==3 || data==4 )
																																																					{	$("#titulo").addClass('titulo-z'+data);
																																																						$( "#zs" ).append( "Zona "+data );
																																																				...
																																																				$.post("php/app_sesiones_ver.php",{name:'aire'},function(data) {
																																																					if (data==1 || data==2 ) {
																																																						$("#a"+data).addClass('selected');
																																																						$("#im"+data).css('transform','scale(1.15)');
																																																					}
																																																				});
																																																			...
																																																			//seleccion aire
																																																			$('[id^=aire]').click(function() {
																																																				var aire=$(this).data('aire');
																																																				var href=$(this).data('href');
																																																				$.post("php/app_sesiones.php",{name:'aire', valor: aire},function(data) {
																																																					console.log(data);
																																																					window.location.href = href;
																																																				});
																																																			...
																																																			{
																																																				console.log( "Elige el tamaño de tu habitación" );
																																																				$.post("php/app_sesiones_ver.php",{name:'zona'},function(data) {
																																																					if (data==1 || data==2 || data==3 || data==4 ) {
																																																						$("#titulo").addClass('titulo-z'+data);
																																																						$( "#zs" ).append( "Zona "+data );
																																																						$( "#zona" ).append( "Zona "+data ).addClass('zona-'+data);
																																																					}
																																																				...
																																																				$.post("php/app_consultas.php",{consulta:'zona_estados'},function(data) {
																																																					if (data==1 || data==2 ) {
																																																						$("#a"+data).addClass('selected');
																																																						$("#im"+data).css('transform','scale(1.15)');
																																																					}
																																																			...
																																																			$('[id^=h-]').click(function() {
																																																				...
																																																				var href=$(this).data('href');
																																																				$.post("php/app_sesiones.php",{name:'habitacion', valor: idh},function(data) {
																																																					console.log(data);
																																																					window.location.href = href;
																																																				});
																																																			...
																																																			{
																																																				console.log( "Tus opciones de aire acondicionado LG" );
																																																				$.post("php/app_sesiones_ver.php",{name:'zona'},function(data) {
																																																					if (data==1 || data==2 || data==3 || data==4 ) {
																																																						$("#titulo").addClass('titulo-z'+data);
																																																						$( "#zs" ).append( "Zona "+data );
																																																			...
																																																			//seleccion aire acondicionado
																																																			$('[id^=p-]').click(function() {
																																																				var seleccion=$(this).data('model');
																																																				var idp=$(this).data('id');
																																																				var href=$(this).data('href');
																																																				$.post("php/app_sesiones.php",{name:'seleccion', valor: idp},function(data) {
																																																					console.log(data);
																																																					window.location.href = href;
																																																				});
																																																			...
																																																			$('.adquierelo').click(function() {
																																																				
																																																				var href=$(this).data('adq');
																																																				console.log(href);
